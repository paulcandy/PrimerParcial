...
import kotlinx.android.synthetic.main.fragment_b_buse_method.*

class BBuseMethodFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        setHasOptionsMenu(true)
         v = inflater.inflate(R.layout.fragment_b_buse_method, container, false)
        return v
    }
    ...
    override fun onStart() {
        ...
        txtMethodUse.text = product.useMethod
